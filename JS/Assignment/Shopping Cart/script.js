...
const outputDiv = document.querySelector(".productscontainer");
...
document.querySelector(".carticon").addEventListener("click", ()=>{
    let targetDiv = document.querySelector(".cartui");
    targetDiv.classList.add("cartopened");
});

document.querySelector(".closecart").addEventListener("click", ()=>{
    let targetDiv = document.querySelector(".cartui");
    targetDiv.classList.remove("cartopened");
});
